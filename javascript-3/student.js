...
// Code Here
var groceries=["apples", "popcorn", "candy"];
...
console.log(groceries.unshift(item));
displayData();
}
...
function removeItem(index){
    ...
    console.log(groceries.splice(item))
}


//////////////////STEP 6////////////////////
//Create a function called 'checkGroceryCount'. Inside of the function check the total 
//number of groceries you need to get using .length. Using an else/if statement, 
//check if the number is greater than or equal to 5, return the string 
//'That looks like a big trip' from the function. If the number of groceries is equal to 
//one, return the string '1 item'. For numbers between 1 and 5, return the string 
//'NUMBER items' with number replacing the number of items
